...
lastUpdatedOn: 2026-09-16T05:43:01.113Z
prev: true
next: true
prereqs:
  - s5/computer-security/confidentiality-integrity-availability#access-control
---
...
Developer accounts use MFA and access logging. Build servers sit on an isolated network. Dev and deployment environments are separate. Access is role-based, backed by a formal [access control model](/s5/computer-security/confidentiality-integrity-availability#access-control).
