...
lastUpdatedOn: 2026-09-25T19:34:07.536Z
...
$$
\text{Net Purchases} = \text{Purchases} - \text{Return Outwards} + \text{Carriage Inwards}
$$

$$
\text{Net Sales} = \text{Sales} - \text{Return Inwards}
$$
