...
lastUpdatedOn: 2026-09-13T14:55:24.615Z
---
...
Add $-0.5s_2 + G = -0.5$ to the tableau and resolve with dual simplex:

- $G$'s row leaves ($b = -0.5$).
- $s_2$ enters, its only negative coefficient.
- Pivoting on $s_2$ gives $x_1 = 2$, $x_2 = 3$, $s_2 = 1$, all integral.
