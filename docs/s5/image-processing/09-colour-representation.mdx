...
A 1920x1024 image has under 2 million pixels, so it needs at most 2 million distinct colours, far fewer than the $2^{24}$ colours RGB can represent.
...
- Palette length determines how many distinct colours can be used at once, out of the full $2^{24}$
