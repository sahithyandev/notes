...
lastUpdatedOn: 2026-09-13T22:30:43.665Z
...
<Note>
  - SIP = establishes/manages the session - RTP = carries real-time media - RTCP
  = provides control/feedback about RTP
</Note>
...
<SequenceDiagram
  participants={[
    { name: "Alice", sub: "167.180.112.24" },
    { name: "Bob", sub: "193.64.210.89" },
  ]}
  steps={[
    {
      from: 0,
      to: 1,
      label: "INVITE (Port 5060, SDP: PCM, Port 38060)",
      title: "Alice sends INVITE with her media address, port, and codec.",
    },
    {
      from: 1,
      to: 1,
      kind: "note",
      label: "(Ringing)",
      title: "Bob's phone rings.",
    },
    {
      from: 1,
      to: 0,
      label: "200 OK (Port 5060, SDP: GSM, Port 48753)",
      title: "Bob responds with his media address, port, and codec.",
    },
    {
      from: 0,
      to: 1,
      label: "ACK (Port 5060)",
      title: "Alice confirms the call setup.",
    },
    {
      from: 0,
      to: 1,
      kind: "media",
      label: "RTP Media Stream (bidirectional)",
      title: "Endpoints exchange RTP media packets directly.",
    },
  ]}
/>
