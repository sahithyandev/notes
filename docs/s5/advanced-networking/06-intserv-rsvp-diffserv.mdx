  ...
  steps={[
    {
      ...
      label: "PATH (T-spec)",
      title:
        "PATH messages travel downstream following unicast/multicast routing paths.",
    },
    {
      from: 1,
      to: 2,
      label: "PATH (T-spec)",
      title:
        "Each router records reverse-path state so RESV messages can find their way back.",
    },
    {
      from: 2,
      to: 1,
      label: "RESV (R-spec)",
      title:
        "The receiver sends RESV upstream along the reverse path, triggering admission control.",
    },
    {
      from: 1,
      to: 0,
      label: "RESV (R-spec)",
      title:
        "Accepted routers allocate scheduler resources and install packet filter rules.",
    },
  ]}
/>
...
<Note>
  Packet marking happens in: - IPv4 Type of Service (ToS) field. - IPv6 Traffic
  Class field.
</Note>
