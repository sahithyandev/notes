...
lastUpdatedOn: 2026-09-12T20:33:29.807Z
...
- Streams: audio, video, text, slides, or whiteboard data.
- Examples: AVI, ASF, WMV, FLV, MPEG.
...
- Uses: fax, presentation files, medical images.

Lossy codec — discards selected information.

- Uses: audio and video.
...
- Source: voiced buzz or unvoiced noise.
- Filter: vocal-tract resonance.
- Formants: resonance peaks in the frequency spectrum.
...
- Motion perception: approximately $12\ \text{fps}$.
- Cinema: $24\ \text{fps}$.
- PAL television: $25\ \text{fps}$.
