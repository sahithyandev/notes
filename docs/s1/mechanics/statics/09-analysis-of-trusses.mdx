...
lastUpdatedOn: 2026-04-28T07:56:31.636Z
---
...
| Case                                                   | Description                                                |
| ------------------------------------------------------ | ---------------------------------------------------------- |
| ![a](/s1/mechanics/joints-under-special-loading/a.jpg) | $F_{\text{AX}}=F_{\text{XB}}, F_{\text{DX}}=F_{\text{XC}}$ |
| ![b](/s1/mechanics/joints-under-special-loading/b.jpg) | $F_{\text{P}}=F_{\text{XB}}, F_{\text{DX}}=F_{\text{XC}}$  |
| ![c](/s1/mechanics/joints-under-special-loading/c.jpg) | $F_{\text{XB}}=0, F_{\text{DX}}=F_{XC}$                    |
| ![d](/s1/mechanics/joints-under-special-loading/d.jpg) | $F_{\text{DX}}=F_{\text{XC}}$                              |
| ![e](/s1/mechanics/joints-under-special-loading/e.jpg) | $F_{\text{DX}}=F_{\text{XC}}=0$                            |
