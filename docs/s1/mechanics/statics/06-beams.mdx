...
lastUpdatedOn: 2026-05-31T13:38:52.592Z
---

![Beam](/s1/mechanics/beam.jpg)
...
| Type                      | Image                                                                     | Notes                           |
| ------------------------- | ------------------------------------------------------------------------- | ------------------------------- |
| Simply supported beam     | ![Simply supported beam](/s1/mechanics/simply-supported-beam.jpg)         | **At ends**: Max SF and BM = 0  |
| Cantilevered beam         | ![Cantilevered beam](/s1/mechanics/cantilevered-beam.jpg)                 | **At fixed end**: Max SF and BM |
| Overhanging beam          | ![Overhanging beam](/s1/mechanics/overhanging-beam.jpg)                   |                                 |
| Propped cantilevered beam | ![Propped cantilevered beam](/s1/mechanics/propped-cantilevered-beam.jpg) |                                 |
| Continuous beam           | ![Continuous beam](/s1/mechanics/continuous-beam.jpg)                     |                                 |
| Fixed beam                | ![Fixed beam](/s1/mechanics/fixed-beam.jpg)                               | **At ends**: Max SF and BM      |

## At a section

![At a section](/s1/mechanics/at-a-section.jpg)
