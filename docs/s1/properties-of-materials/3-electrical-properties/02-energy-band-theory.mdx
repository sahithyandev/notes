...
lastUpdatedOn: 2026-09-25T19:32:17.502Z
---
...
- Valence band  
  The highest energy band that can be occupied by electrons at $0\,\text{K}$.
- Conduction band  
  The empty band just above the valence band.
...
At $T>0$, there is more chance that the electrons can be available in
conduction band. The chance increases with increasing temperature.
