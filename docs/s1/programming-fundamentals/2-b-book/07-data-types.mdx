...
lastUpdatedOn: 2026-09-13T05:26:37.726Z
---
...
- Max heap  
  When the parent node value is greater than its children nodes
- Min heap  
  When the parent node value is smaller than its children nodes
