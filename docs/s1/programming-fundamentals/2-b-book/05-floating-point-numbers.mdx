...
lastUpdatedOn: 2026-09-25T19:32:17.473Z
---
...
- Add $127$ to exponent to get $131$
- Convert exponent to binary $10000011$
- Write the final result as $0\;10000011\;11110101000000000000000$

Take $-0.125$.

- In binary, $-0.001_2$
- In binary scientific notation, $-1.0_2 \times 2^{-3}$
- Add $127$ to exponent to get $124$
- Convert exponent to binary $01111100$
- Write the final result as $1\;01111100\;00000000000000000000000$
...
- In binary, $11111.0101_2$
- In binary scientific notation, $1.11110101_2 \times 2^4$
- Add $1023$ to exponent to get $1027$
- Convert exponent to binary as $10000000011$
...
- In binary, $-0.001_2$
- In binary scientific notation, $-1.0_2 \times 2^-3$
- Add $1023$ to exponent to get $1020$
- Convert exponent to binary as $1111111100$
- Write the final result as
