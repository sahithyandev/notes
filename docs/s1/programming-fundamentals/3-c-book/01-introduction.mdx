...
lastUpdatedOn: 2026-09-13T05:26:37.735Z
---
...
- [Hardware](/s1/programming-fundamentals/c-book/computer-hardware/)  
  Tangible elements that can be seen and touched
- [Software](/s1/programming-fundamentals/c-book/computer-software/)  
  Programs that allow users to use the computer system and control its
  activities. Not tangible.
- Data  
  Individual facts or pieces of information that is input to the computer for
  processing or produces as output after processing.
- User(s)
