...
lastUpdatedOn: 2026-09-13T14:55:22.266Z
---
...
1. If $\lim_{n\to\infty} u_n \neq 0$ is apparent, then
   [divergence test](/s1/mathematics/real-analysis/convergence-tests/#divergence-test)
   can be used. Otherwise look out for another way.
2. If $u_n$ consists of a constant raised to a power of $n$,
   [geometric series](/s1/mathematics/real-analysis/known-series/#geometric-series)
   can be used.
3. If $u_n$ consists of $n$ raised to a constant power,
   [p-series](/s1/mathematics/real-analysis/known-series/#p-series) can be used.
4. If $u_n$ consists of $(-1)^n$,
   [alternating series test](/s1/mathematics/real-analysis/alternating-series/#convergence-test)
   can be used.
5. If $u_n$ consists of $v_n$ raised to a power of $n$,
   [root test](/s1/mathematics/real-analysis/convergence-tests/#root-test) would be
   suitable.
6. If $u_n$ includes $n!$,
   [ratio test](/s1/mathematics/real-analysis/convergence-tests/#ratio-test) must
   be used.
7. If $u_n$ is a fraction, and consists of $n$ in both the denominator and the
   numerator, then
   [direct comparison test](/s1/mathematics/real-analysis/convergence-tests/#direct-comparison-test)
   or
   [limit comparison test](/s1/mathematics/real-analysis/convergence-tests/#limit-comparison-test)
...
[direct comparison test](/s1/mathematics/real-analysis/convergence-tests/#direct-comparison-test)
or
[limit comparison test](/s1/mathematics/real-analysis/convergence-tests/#direct-comparison-test).
