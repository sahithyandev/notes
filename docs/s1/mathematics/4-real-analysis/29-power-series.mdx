...
lastUpdatedOn: 2026-06-08T16:03:34.645Z
---
...
[ratio test](/s1/mathematics/real-analysis/convergence-tests#ratio-test) or
[root test](/s1/mathematics/real-analysis/convergence-tests#root-test).
...
- Diverging for $\lvert x-a \rvert \gt R$
