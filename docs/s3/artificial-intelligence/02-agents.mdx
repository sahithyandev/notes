...
lastUpdatedOn: 2026-05-18T05:47:11.169Z
---
...
An agent program's effectiveness is measured through a [performance measure](/artificial-intelligence/performance-measure/). An agent is the combination of the agent program and the agent architecture.
