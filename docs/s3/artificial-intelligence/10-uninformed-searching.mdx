...
lastUpdatedOn: 2026-09-13T14:55:22.992Z
---
...
Covered in detail in [DFS on Graphs](/s2/data-structures-and-algorithms/algorithms/depth-first-search/#in-graphs).
...
Expands the shallowest nodes first. Covered in detail in [BFS on Graphs](/s2/data-structures-and-algorithms/algorithms/breadth-first-search/#in-graphs).
...
Aka. [Dijkstra's algorithm](/s2/data-structures-and-algorithms/algorithms/dijkstras-algorithm/). Fails for graphs with negative weights. Expands the node with the lowest path cost. Optimal for general action costs. Named _uniform_ because it expands nodes in increasing order of path cost.
