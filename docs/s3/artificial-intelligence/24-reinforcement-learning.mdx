...
lastUpdatedOn: 2026-09-13T14:55:23.038Z
---
...
A challenge for active RL. The agent must balance:

- Explore  
  Try new actions to discover rewards.
- Exploit  
  Use the best-known action for high return.
...
Model-free. Active. Learns action values $Q(s, a)$ directly to find the optimal policy. Does [sample-based](#sample-based-policy-evaluation), [q-value iteration](/s3/artificial-intelligence/mdp#q-value-iteration).
