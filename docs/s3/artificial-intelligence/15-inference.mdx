...
lastUpdatedOn: 2026-09-13T04:35:59.480Z
---
...
A rule-based inference method suitable for automated theorem proving. Allows fully mechanical proofs and is widely used in logic-based AI systems. Applies to sentences in [Conjunctive Normal Form](/s3/artificial-intelligence/propositonal-logic#conjunctive-normal-form).
