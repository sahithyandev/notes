...
A rule-based inference method suitable for automated theorem proving. Allows fully mechanical proofs and is widely used in logic-based AI systems. Applies to sentences in [Conjunctive Normal Form](/s3/artificial-intelligence/proposition-logic#conjunctive-normal-form).
