...
lastUpdatedOn: 2026-09-13T14:55:22.974Z
---
...
- Vacuum cleaner  
  Amount of dirt removed per unit time, not number of actions taken.
- Chess agent  
  Win/loss/draw outcome, not number of pieces captured.
- Medical diagnosis agent  
  Patient health outcomes, not number of diagnoses made.
