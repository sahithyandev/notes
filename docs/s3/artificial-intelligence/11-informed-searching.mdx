...
lastUpdatedOn: 2026-09-13T04:35:59.464Z
---
...
- In the 8-puzzle  
  Number of misplaced tiles or Manhattan distance.
...
A variant of best-first search. Uses heuristic function alone. Similar to [BFS](/s3/artificial-intelligence/uninformed-searching#breadth-first-search). Puts a limit (_beam width_) on the size of the frontier. Not complete, and not optimal. Because some nodes are discarded.
