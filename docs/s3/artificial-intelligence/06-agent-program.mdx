...
lastUpdatedOn: 2026-09-08T19:46:17.691Z
---
...
More flexible than reflex agents. Among all the possible actions, the agent will take the action which is most likely help itself to achieve the goal. Uses [searching](/s3/artificial-intelligence/searching-problem/) or planning to decide.
