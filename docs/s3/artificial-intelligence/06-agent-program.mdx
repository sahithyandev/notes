...
More flexible than reflex agents. Among all the possible actions, the agent will take the action which is most likely help itself to achieve the goal. Uses [searching](/s3/artificial-intelligence/searching) or planning to decide.
