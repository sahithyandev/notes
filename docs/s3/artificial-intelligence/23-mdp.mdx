...
lastUpdatedOn: 2026-09-13T14:55:23.033Z
---
...
- $\gamma$: [discount factor](#discounting-rewards)
...
- Policy evaluation  
  Given a (fixed) policy π, compute its state-value function V^π (exactly or approximately).
- Policy improvement  
  Produce a new greedy policy π' by acting greedily with respect to V^π.
