...
lastUpdatedOn: 2026-09-13T14:55:23.435Z
---

Ideal gases follow simple relations between $P$, $V$, and $T$. Can be applied to [ideal gases](/s3/engineering-thermodynamics/introduction#ideal-gases).
...
- Specific gravity  
  Ratio of fluid density to reference density (water for liquids, air for gases).
