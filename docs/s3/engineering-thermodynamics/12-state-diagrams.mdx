...
lastUpdatedOn: 2026-09-13T14:55:23.430Z
---
...
- In the compressed liquid region, temperature rises with a small volume change.
- At the saturated liquid line, temperature is fixed at $T_\text{sat}$ and boiling begins.
- Under the dome, temperature stays constant while volume increases as $x$ increases.
- At the saturated vapour line, the phase change is complete.
- In the superheated region, both temperature and volume rise.
