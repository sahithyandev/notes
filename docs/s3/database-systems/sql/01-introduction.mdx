...
A declarative [DML](/s3/database-systems/introduction/#dml) and [DDL](/s3/database-systems/introduction/#ddl). Case insensitive. Became the industry standard in the 1980s.
