...
lastUpdatedOn: 2026-09-13T14:55:23.253Z
---
...
Data is organized into entities with attributes and relationships. Used only in the design phase. Used to implement relational model. Explained more on [Entity-Relationship Model](/s3/database-systems/basics/entity-relationship-model)
