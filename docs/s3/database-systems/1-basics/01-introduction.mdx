...
lastUpdatedOn: 2026-09-13T14:55:23.247Z
---
...
Handles execution of queries. Parses, and translates queries to [relational algebra](/s3/database-systems/basics/relational-algebra). Optimizes the generated expression and creates an execution plan. Execution engine runs the plan and returns the results.
