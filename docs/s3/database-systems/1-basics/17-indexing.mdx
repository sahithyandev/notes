...
lastUpdatedOn: 2026-09-13T14:55:23.320Z
---
...
- Access time  
  How quickly data is found.
- Insertion/deletion time  
  Update performance.
- Space overhead  
  Extra storage used by index.
- Supported access types  
  Exact-match or range-based.
...
- For example, `h(DeptName) = sum(char codes) mod 10`.
...
- Overflow chaining links overflow buckets in a list.
