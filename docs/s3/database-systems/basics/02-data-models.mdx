...
Data is organized into entities with attributes and relationships. Used only in the design phase. Used to implement relational model. Explained more on [Entity-Relationship Model](/s3/database-systems/entity-relationship-model)
