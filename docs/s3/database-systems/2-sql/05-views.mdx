...
lastUpdatedOn: 2026-09-13T04:35:59.830Z
---
...
- Immediate (on commit)  
  The view is updated whenever the base tables change.
- Manual (on demand)  
  The view is refreshed only when explicitly requested.
- Scheduled  
  The view is refreshed at regular intervals.
