...
lastUpdatedOn: 2026-09-13T14:55:23.134Z
---
...
- Dialog control (full vs half duplex)  
  Decides who can send data and when. Prevents data collisions and ensures proper ordering of data packets.
- Token management
- Synchronization  
  Manages the timing of data transmission to ensure that data is transmitted at the right time.
- Recovery management
...
- Logical addressing  
  Determines which machine to send the packet to.
- Routing  
  Determines how to reach the destination efficiently.
...
- Data framing  
  Divides a data stream into manageable chunks.
- Error detection and correction
- Flow control  
