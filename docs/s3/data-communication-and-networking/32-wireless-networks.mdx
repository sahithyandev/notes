...
lastUpdatedOn: 2026-09-13T04:35:59.731Z
---
...
- Address 1  
  MAC address of the wireless receiving station.
- Address 2  
  MAC address of the wireless transmitting station.
- Address 3  
  MAC address of the (router) interface via which the BSS connects to other networks.
- Address 4  
  Used for Ad-hoc mode of operation.
...
- PCF  
  Polling by Centralized Polling Master.
