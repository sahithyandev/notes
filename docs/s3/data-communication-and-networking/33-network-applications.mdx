...
lastUpdatedOn: 2026-09-21T13:41:33.721Z
---
...
- Peer  
  A device that participates in a peer-to-peer network.
- Seeder  
  A peer that provides the complete file.
- Initial seeder  
  A peer that provides the initial copy.
- Tracker  
  A computer that coordinates the file distribution.
- Leecher  
  A peer that downloads the file from other peers.
