...
Same physical path shared by multiple calls in different time-slots. Uses [TDM](/s3/data-communication-and-networking/multiplexing/#synchronous-time-division-multiplexing).
...
No need of dedicated paths. Ideal for bursty data. [Jitter](/s3/data-communication-and-networking/transmission-errors/#jitter) is possible. Packets may arrive out of order.
