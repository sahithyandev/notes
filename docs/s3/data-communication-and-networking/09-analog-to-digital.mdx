...
Analog signal is measured at regular intervals. Must be sampled at $2f$ frequency where $f$ is the highest signal frequency, as [Nyquist theorem](/s3/data-communication-and-networking/signals#nyquist-theorem) says.
