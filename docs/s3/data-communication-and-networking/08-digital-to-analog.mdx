...
lastUpdatedOn: 2026-09-13T14:55:23.159Z
---
...
- Binary 1  
  Carrier signal transmitted at one frequency ($f_1$).
- Binary 0  
  Carrier signal transmitted at another frequency ($f_0$).
...
- For low frequencies, the bit rate dominates the bandwidth
