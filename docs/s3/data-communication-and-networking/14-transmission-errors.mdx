...
lastUpdatedOn: 2026-09-13T14:55:23.180Z
---
...
- Jitter buffers  
  Temporarily store incoming data packets to ensure a steady stream of data to the receiver.
- Shielding  
  Protects signal carrying cables from EM or radio frequency interference.
