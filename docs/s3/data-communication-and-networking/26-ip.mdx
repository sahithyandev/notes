...
sidebar:
  order: 26
slug: s3/data-communication-and-networking/ip
prev: true
next: true
dateCreated: 2026-04-22T07:09:10.693Z
lastUpdatedOn: 2026-09-08T19:46:17.697Z
---
...
IP defines how to address devices (or interfaces) on a network. It assigns a unique IP address to each network interface, allowing them to communicate with each other.
...
Uses 32 bits. Supports 4.3 billion devices. Composed of 4 octets. Each octet is represented by a decimal number between <span class="font-mono">0</span> and <span class="font-mono">255</span>. For example, an IP address might be written as <span class="font-mono">192.168.0.1</span>.

### IPv6

Uses 128 bits. Supports 3.4 x 10^38 devices. Composed of 8 groups of 16 bits. Each group is represented by a hexadecimal number between <span class="font-mono">0</span> and <span class="font-mono">FFFF</span>. For example, an IP address might be written as <span class="font-mono">2001:0db8:85a3:0000:0000:8a2e:0370:7334</span>.

<Note>

For this module, IPv6 is referred to as "IP", if not mentioned otherwise. [IPv4](/s4/computer-networks/ipv4) and [IPv6](/s4/computer-networks/ipv6) are covered extensively in the next semester.
...
IP address ranges (aka. blocks) reserved for private networks. Globally non-routable. Not globally unique. Unique within a private network.
