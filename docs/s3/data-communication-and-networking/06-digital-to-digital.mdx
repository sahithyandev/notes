...
lastUpdatedOn: 2026-04-28T07:56:31.650Z
---
...
Short for Alternate Mark Inversion. Most common [bipolar encoding scheme](/s3/data-communication-and-networking/encoding-decoding#biploar-encoding). 0 is represented by 0. 1 is represented by non-zero level, with alternating polarity.
...
- Can detect errors ([bipolar violation](/s3/data-communication-and-networking/encoding-decoding#biploar-violation))
