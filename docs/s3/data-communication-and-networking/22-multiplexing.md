...
sidebar:
  order: 22
slug: s3/data-communication-and-networking/multiplexing
prev: true
next: true
dateCreated: 2026-04-22T07:09:10.693Z
lastUpdatedOn: 2026-04-22T07:15:36.793Z
---
...
- In wired medium, cost per kbps is lower for higher bandwidth
...
- [Time Division Multiplexing (TDM)](#synchronous-time-division-multiplexing)
...
A link's bandwidth is divided into multiple frequency ranges. Each frequency range is assigned to a signal. Guard bands are placed in between to avoid interference.
...
Aka. WDM. Used in optical fiber. Similar to FDM.
...
Time slots are wasted if sources are idle.
...
Aka. Statistical TDM. Dynamically allocates time slots on demand. Avoids wasting time slots because of idle sources. Supports more devices than synchronous TDM. Typically, uses HDLC protocol.
