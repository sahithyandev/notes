...
lastUpdatedOn: 2026-09-13T04:35:59.655Z
---
...
- Core operations  
  Matrix–matrix multiply, convolution, ReLU, sigmoid, tanh.
...
- Each core  
  128+64 MiB memory, 16×16 2D array processing elements, 2D SIMD & VLIW.
