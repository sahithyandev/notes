...
Can be paused and resumed. Paused through [interrupts](/operating-systems/interrupt-driven-io#interrupt). In that case, CPU context-switches to Interrupt Service Routine.
...
- Homogeneous multi-core: all cores are identical.
- Challenges:
...
- CPU hardware: MMU, page tables, permission bits
...
- Work partitioning: which core does what?
