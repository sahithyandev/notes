...
Single CPU. Only one instruction stream runs at any instant. Uses [multiprogramming](/s3/operating-systems/introduction#multiprogramming) and [preemptive scheduling](/s3/operating-systems/cpu-scheduling/#preemptive). Most common design.
