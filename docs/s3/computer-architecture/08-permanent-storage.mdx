...
lastUpdatedOn: 2026-09-13T14:55:23.071Z
prereqs:
  - s1/programming-fundamentals/c-book/secondary-storage
  - s1/programming-fundamentals/c-book/magnetic-storage
---
...
Small unit of readable/writeable data. Circular segments within tracks. Each sector contains header information, data, [error correction code](/s3/operating-systems/mass-storage-systems/#ecc). Usually data size is 512 bytes or 4096 bytes. 500 to 2000 sectors per track. More sectors on outer tracks due to larger circumference.
...
Limited write cycles ([wear leveling](/s3/operating-systems/mass-storage-systems/#wear-leveling) required). Write in pages. Erase in blocks. Limited write endurance (mitigated by controller algorithms). Erase operations are much slower and cause wear.
