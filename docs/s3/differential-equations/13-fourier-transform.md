...
Similar to [in Laplace Transform](/differential-equations/laplace-transform/#time-scaling). When $\alpha \gt 0$:
...
Similar to in [Laplace Transform](/differential-equations/laplace-transform). When $\alpha \gt 0$:
