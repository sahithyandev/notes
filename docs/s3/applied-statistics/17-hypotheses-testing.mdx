...
For a single sample, either [critical value method](/s3/applied-statistics/critical-value-method) or [p-value method](/s3/applied-statistics/p-value-method) can be used. Both produce the same results.
