...
Can be thought of as an continuous analogue of the [geometric distribution](/s3/applied-statistics/geometric-distribution/). Often used to model the length of time until an event occurs. [Memoryless](/s3/applied-statistics/introduction/#memorylessness).
