...
Only the [geometric](/s3/applied-statistics/geometric-distribution/) and [exponential distribution](/s3/applied-statistics/07-exponential-distribution/) are memoryless.
