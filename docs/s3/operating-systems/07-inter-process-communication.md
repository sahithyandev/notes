...
sidebar:
  order: 7
  label: IPC
slug: s3/operating-systems/inter-process-communication
prev: true
next: true
...
kernel handles a message queue. Processes send and receive messages using syscalls. A communication link must be established between 2 processes.
