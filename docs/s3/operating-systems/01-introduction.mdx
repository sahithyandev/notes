...
Transition to kernel mode happens via [system calls](/s3/operating-systems/kernel#system-calls).
...
Not to be confused between Macintosh. Uses a microkernel. [Syscalls](/s3/operating-systems/kernel#system-calls) and [IPC](/s3/operating-systems/inter-process-communication) is message-based. Ports are used for communication.
