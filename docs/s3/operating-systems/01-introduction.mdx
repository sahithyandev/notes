...
Transition to kernel mode happens via [system calls](/s3/operating-systems/kernel#system-call).
...
Not to be confused between Macintosh. Uses a microkernel. [Syscalls](/s3/operating-systems/kernel#system-call) and [IPC](/s3/operating-systems/inter-process-communication) is message-based. Ports are used for communication.
