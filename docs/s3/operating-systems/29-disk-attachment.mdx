...
lastUpdatedOn: 2026-09-13T14:55:23.565Z
---
...
The Storage Area Network (SAN) controller (aka. storage array controller) manages [RAID](/s3/operating-systems/raid), caching.
