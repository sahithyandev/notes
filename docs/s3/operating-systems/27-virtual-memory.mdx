...
If a process is currently doing an I/O operation, it cannot be swapped out. Can be solved by [double buffering](/s3/operating-systems/io-systems#double-buffering).
