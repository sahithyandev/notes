...
lastUpdatedOn: 2026-09-25T06:53:38.704Z
---
...
- Data bus  
  Carries actual data.
- Address bus  
  Carries device or memory addresses.
- Control bus  
...
- PCI  
  System-wide. Connects CPU, memory, and disk controller.
- USB  
  System-wide. Connects multiple peripherals like a keyboard and webcam.
...
- Data-in Register  
  Holds data from the device.
- Data-out Register  
  Holds data to send to the device.
- Status Register  
...
Explained on [its own page](/s3/operating-systems/interrupt-driven-io).
