...
- Sets up [interrupt handlers](/s3/operating-systems/interrupt-driven-io/#interrupt)
- Initializes memory management
- Detects and initializes [device drivers](/s3/operating-systems/io-system/#device-driver)
