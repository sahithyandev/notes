...
A communication method where a data stream is divided into smaller packets and transmitted independently through the network. More efficient than [leased lines](/s4/man-and-wan/#leased-lines).
