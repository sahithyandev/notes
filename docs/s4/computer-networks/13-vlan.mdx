...
Port connecting a switch to another switch or a router. Carries multiple VLANs simultaneously over a single physical link. Standard choice for switch-to-switch connections as it is scalable. Uses [802.1Q tagging](#802).
