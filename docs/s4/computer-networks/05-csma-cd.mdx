...
lastUpdatedOn: 2026-09-12T09:34:04.739Z
...
Jam signal: non-data bit pattern transmitted after collision detection. Ensures all stations recognize the collision before back-off begins.
...
- Twisted pair  
  $100$ m (same as 10/100BASE-T).
- Multi-mode fibre  
  Up to $2$ km (full duplex). ~$412$ m on some fibres (half duplex).
- Single-mode fibre  
  $20$ km or more.
