...
lastUpdatedOn: 2026-09-13T14:55:23.658Z
---
...
- IPv4  
  Fragmentation by any router along the path.
- IPv6  
  Fragmentation only at the source (routers drop oversized packets and send ICMPv6 Packet Too Big).
