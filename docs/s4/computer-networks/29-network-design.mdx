...
lastUpdatedOn: 2026-09-12T09:34:04.896Z
---
...
- IT environment, covering data centre, security, systems management, disaster recovery, IT organization and processes.
...
- Only explicitly whitelisted traffic is permitted inbound (default-deny policy).
