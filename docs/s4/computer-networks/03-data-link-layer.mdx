...
lastUpdatedOn: 2026-06-04T14:41:47.356Z
---

Layer 2 of the OSI model. Handles data communication through a single link, between adjacent nodes.

Handles synchronisation, error control, flow control, data compression, and encryption. For shared media, it also manages media access control and logical link control.
