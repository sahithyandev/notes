...
Count-to-infinity: two routers increment each other's stale route indefinitely after a link goes down. Mitigated by split horizon or route poisoning. RIP caps hops at 15 to bound the problem.
