...
lastUpdatedOn: 2026-06-04T20:58:06.730Z
---
...
Intended for use within an organization. Prefix `fec0::/10`. Deprecated in 2004 because the spec did not clearly define a _site_. Replaced by Unique Local Addresses.
...
Replaces IPv4 broadcast. No addresses are wasted on network or broadcast addresses.
...
IPv6 header is always 40 bytes (fixed length). No checksum.
