...
lastUpdatedOn: 2026-09-13T14:55:23.635Z
---
...
Denoted by `::`. Used when the address is not yet known.

#### Loopback

Denoted by `::1`. Equivalent to `127.0.0.1` in IPv4. Sends packets to the same host.
