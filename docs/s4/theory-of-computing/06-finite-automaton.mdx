...
lastUpdatedOn: 2026-06-09T19:59:41.775Z
---
...
Suppose $M_1 = (Q_1, \Sigma, q_1, A_1, \delta_1)$ and $M_2=(Q_2, \Sigma, q_2, A_2, \delta_2)$ are FAs accepting languages $L_1$ and $L_2$ respectively.

Let:

$$
\begin{aligned}
M &=(Q_1 \times Q_2, \Sigma, (q_1, q_2), A, \delta) \\
\delta((p,q), a) &= (\delta_1(p, a), \delta_2(q, a))
\end{aligned}
$$

Based on how $A \subseteq A_1 \times A_2$ is defined, $M$ can accept different languages: $L_1 \cup L_2$ or $L_1 \cap L_2$ or $L_1 - L_2$.
