...
lastUpdatedOn: 2026-06-09T19:59:41.773Z
...
2 strings $x$ and $y$ are distinguishable with respect to a language $L$ if their [language quotients](/s4/theory-of-computing/introduction/#language-quotient) are different.
