...
Traditionally FAs are concerned with accepting or rejecting strings. But they can also generate outputs from an output alphabet. Will be covered in [Moore Machines](/s4/theory-of-computing/moore-machines) and later.
