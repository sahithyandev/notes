...
lastUpdatedOn: 2026-09-13T14:55:24.184Z
...
- The [Halting Problem](/s4/theory-of-computing/decidability#halting-problem)  
  Given a TM and input, decide if the TM halts. Proven undecidable by diagonalization.
- Rice's Theorem  
  Any non-trivial semantic property of a TM's language is undecidable.

### Undecidability Transfer

To show a new problem $P$ is undecidable, reduce a known undecidable problem (typically the Halting Problem) to $P$. If a TM for $P$ existed, it would solve the Halting Problem, a contradiction.
