...
Equivalent FAs can have different numbers of states, different transition functions, and different state names.

Any regular language can be recognized by a DFA, or an NFA, or an NFA-$\Lambda$.
