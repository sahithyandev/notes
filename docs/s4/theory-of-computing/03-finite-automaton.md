...
Traditionally FAs are concerned with accepting or rejecting strings. But they can also generate outputs from an output alphabet. Will be covered in [Moore Machines](/theory-of-computing/moore-machines) and later.
...
Two strings $x$ and $y$ are distinguishable with respect to a language $L$ if their [language quotients](/theory-of-computing/introduction/#language-quotient) (with respect to $L$) are different.
