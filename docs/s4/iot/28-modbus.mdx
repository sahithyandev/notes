...
lastUpdatedOn: 2026-06-12T08:40:30.611Z
---
...
<Packet
  unit="chars"
  fields={[
    { name: "Function Code", size: 1, label: "1 byte" },
    { name: "Data", size: 3, label: "N bytes" },
  ]}
/>
...
<Packet
  unit="chars"
  fields={[
    { name: "Slave Address", size: 1, label: "1 byte" },
    { name: "PDU", size: 3, label: "1+N bytes" },
    { name: "CRC", size: 2, label: "2 bytes" },
  ]}
/>
...
<Packet
  unit="chars"
  fields={[
    { name: "Start", size: 1, label: "1 ch" },
    { name: "Address", size: 2, label: "2 chars" },
    { name: "PDU", size: 6, label: "2+2N chars" },
    { name: "LRC", size: 2, label: "2 ch" },
    { name: "End", size: 2, label: "2 chars" },
  ]}
/>
...
<Packet
  unit="chars"
  fields={[
    { name: "Transaction ID", size: 2, label: "2 bytes" },
    { name: "Protocol ID", size: 2, label: "2 bytes" },
    { name: "Length", size: 2, label: "2 bytes" },
    { name: "Unit ID", size: 1, label: "1 byte" },
    { name: "PDU", size: 4, label: "1+N bytes" },
  ]}
/>
