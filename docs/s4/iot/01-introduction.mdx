...
IoT refers to a network of physical devices (aka. [things](/s4/iot/thing)) that interact with the environment, to collect and exchange data over a network, usually, the internet.
