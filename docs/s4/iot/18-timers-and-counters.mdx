...
lastUpdatedOn: 2026-06-11T10:59:59.355Z
...
PWM is a special case. The timer resets at a period compare match. A second compare match controls the duty cycle transition. See [Pulse Width Modulation](#pulse-width-modulation).
