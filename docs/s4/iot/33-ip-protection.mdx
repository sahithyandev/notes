...
lastUpdatedOn: 2026-09-12T09:34:05.130Z
---
...
- STM32 RDP
  - Level 0  
    Default. Flash fully readable via debug.
  - Level 1  
    Debug read disabled. Transitioning back to Level 0 triggers a mass erase, destroying the firmware.
  - Level 2  
    Permanent. Debug interface fully and irreversibly disabled.
- AVR lock bits  
