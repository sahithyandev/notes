...
lastUpdatedOn: 2026-09-13T14:55:23.845Z
---
...
- STM32 HAL (STMicroelectronics)  
  `HAL_GPIO_WritePin()`, `HAL_UART_Transmit()`, etc.
- AVR-libc (Atmel/Microchip)  
  Low-level C library for AVR, includes `<avr/io.h>`, `<avr/interrupt.h>`.
- ESP-IDF (Espressif)  
  Full framework for ESP32 covering Wi-Fi, Bluetooth, flash, and peripherals.
