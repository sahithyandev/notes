...
lastUpdatedOn: 2026-05-10T04:24:47.759Z
prereqs:
...
A subgraph of a tree which is also a tree. Any connected subgraph of a tree is a subtree ([as acyclicity is inherited](/s4/grpah-theory/types-of-graphs#acyclic-graph)).
