...
Aka. Eulerian graph. A connected graph that contains an [Eulerian circuit](/graph-theory/introduction#euler-circuit).
...
A graph that contains a [Hamiltonian cycle](/graph-theory/introduction/#hamiltonian-cycle). Introduced by William Hamilton in 1857, while studying cycles in the dodecahedron graph.
