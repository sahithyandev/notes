...
- [Buffer overflows](/operating-systems-security/buffer-overflow)
- [Improper input validation](/operating-systems-security/code-injection#input-validation)
- [Unsafe libraries](/operating-systems-security/buffer-overflow#unsafe-libraries)
- [Injection attacks](/operating-systems-security/code-injection)
- [Malware](/operating-systems-security/malware)
