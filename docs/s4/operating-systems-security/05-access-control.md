...
The mechanism that regulates who (subjects) can access what (objects) and in what way. Protects system resources (files, devices, memory, and network connections). Enforces [CIA](/operating-systems-security/introduction/#cia-triad).
