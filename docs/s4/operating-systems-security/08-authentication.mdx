...
Organizations (service prodivders) trust and rely on 1 or more organizations (identity provider) to authenticate users.
...
Both FIM and SSO:
- Allow users to repeatedly authenticate when moving between systems
