...
An attacker secretly sits between two parties relaying and potentially altering communication.
...
- User-in-the-Middle (UitM)   
  Attacker is between victim and a service. Attacker tricks the victim into authenticating for them.
...
Often installed via plug-ins or malware. Captures login credentials. Can bypass HTTPS protections. Alters transaction data. Steals authentication information.
