...
Errors in programs could lead to security vulnerabilities. For example:
...
Simple. Low cost. Reveals unexpected input errors.

May still miss bugs triggered by specific inputs.
