...
Interaction models describe how users or system components interact with the system. Illustrated using [use case diagrams](/software-engineering/uml-diagrams/#use-case-diagram) and [sequence diagrams](/software-engineering/uml-diagrams/#sequence-diagram).
