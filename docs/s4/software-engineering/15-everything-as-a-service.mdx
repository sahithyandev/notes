...
Provider supplies virtualized compute, storage, and networking. Customer manages everything above the hypervisor such as OS, middleware, runtime, and application. Customers rent raw virtual machines and configure them as needed. No assumption about workload type. Full control, full responsibility.
...
The platform handles scaling, load balancing, patching, and availability automatically.
...
Software product runs on provider's servers. Customers access remotely over the internet. Customers usually pay a subscription for the service.
