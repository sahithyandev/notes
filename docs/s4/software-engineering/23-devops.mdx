...
[Agile](/s4/software-engineering/rapid-software-development) focuses on iterative development. [DevOps](/s4/software-engineering/devops) focuses on integrating development with operations.

| Agile                         | DevOps                              |
| ----------------------------- | ----------------------------------- |
| Improves software development | Improves development and operations |
| Sprint-based delivery         | Continuous delivery                 |
| Focus on customer value       | Focus on deployment and reliability |

Agile addresses how software is built. DevOps addresses how it is deployed and maintained. Combining both removes bottlenecks across the full delivery pipeline.
...
Containerisation packages an application with all its dependencies into a portable, self-contained unit.

Benefits:

- Consistent environments across development, staging, and production.
- Faster deployment due to lightweight startup compared to virtual machines.
- Efficient resource utilization by sharing the host OS kernel.
- Per-service scaling without provisioning full VMs.
- Native fit for cloud and microservices deployments.
