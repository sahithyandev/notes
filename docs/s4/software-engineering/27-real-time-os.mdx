...
Three process classes in a general embedded real-time model:
...
State models are the primary design representation. A stimulus triggers a state transition. [UML state diagrams](/s4/software-engineering/uml) show states as nodes and events as arcs.
...
A Real-Time Operating System (RTOS) is a lightweight platform providing minimal features for real-time software.
...
They provide file systems and runtime process management. Coarse-grained process scheduling control.
