...
Where only changed components and their dependents are recompiled. Dependency model specifies what must be rebuilt when a file changes. Build tool compares modification timestamps of source vs. compiled files and recompiles:
