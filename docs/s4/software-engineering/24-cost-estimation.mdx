...
lastUpdatedOn: 2026-09-25T06:53:39.794Z
...
5 factors that determine $B$. Each rated on a 6-point scale, from 0 (very high) to 5 (extra low). Higher scores indicate weaker project attributes, producing a larger $B$ and steeper scaling penalty.
