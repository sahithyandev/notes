...
lastUpdatedOn: 2026-09-13T04:43:42.417Z
---
...
- Center wavelength  
  The wavelength at which maximum transmission occurs.
- Bandwidth  
  The range of wavelengths that can pass through, often specified as Full Width at Half Maximum (FWHM).
- Transmission efficiency  
  The percentage of light at the peak wavelength that passes through.
- Blocking level  
  How effectively the filter rejects unwanted wavelengths.
