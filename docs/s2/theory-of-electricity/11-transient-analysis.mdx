...
How much of a signal exists at each frequency is analyzed. Signals are expressed as a function of frequency, typically using Fourier or [Laplace transforms](/s2/theory-of-electricity/laplace-transform/). Amplitude and phase vs. frequency are shown.
