...
Used in [Kruskal's algorithm](/s2/data-structures-and-algorithms/algorithms/kruskals-algorithm/), connected components in a graph, cycle detection in undirected graphs, dynamic connectivity problems.
