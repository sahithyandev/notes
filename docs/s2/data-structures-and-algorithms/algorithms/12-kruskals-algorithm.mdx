...
A [greedy algorithm](/s2/data-structures-and-algorithms/algorithms/introduction#greedy-algorithm) to find [MST](/s2/data-structures-and-algorithms/data-structures/minimum-spanning-tree/) of a [graph](/s2/data-structures-and-algorithms/data-structures/graph/). Sorts all edges by increasing weights and adds them one by one to the MST, ensuring that no cycles are formed.
