...
[Depth-first search](/s2/data-structures-and-algorithms/algorithms/depth-first-search) and [breadth-first search](/s2/data-structures-and-algorithms/algorithms/breadth-first-search) are explained in their respective sections.
