...
lastUpdatedOn: 2026-04-28T07:56:31.642Z
---

A [greedy algorithm](/s2/data-structures-and-algorithms/algorithms/introduction#greedy-algorithm) to find [MST](/s2/data-structures-and-algorithms/data-structures/minimum-spanning-tree/) of a [graph](/s2/data-structures-and-algorithms/data-structures/graph/). Starts with a single vertex. Discovered edges are stored in a priority queue. In each turn, MST grows by 1 edge which is the smallest in the discovered edgegs and would not cause a cycle.
