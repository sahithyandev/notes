...
lastUpdatedOn: 2026-06-01T03:58:53.175Z
---
...
## In [Trees](/s2/data-structures-and-algorithms/data-structures/tree)
...
## In [Graphs](/s2/data-structures-and-algorithms/data-structures/graph)
...
4. Add source to stack
5. Pop top node
6. Visit all unvisited neighbors
7. Mark neighbors as visited and push them to stack (in reverse order for consistent traversal)
