...
lastUpdatedOn: 2026-09-13T14:55:22.837Z
---
...
- Class Diagrams  
  Show the static structure of the system, including classes, attributes,
  methods, and relationships.
- Sequence Diagrams  
  Show how objects interact in a particular sequence of time.
- Use Case Diagrams  
  Show the interactions between actors and the system.
...
- Extensibility  
  Easily extend existing classes to create new functionality.
- Reusability  
  Reuse existing code to reduce redundancy.
- Duplicate code elimination  
  Common functionality is centralized in the parent class.
