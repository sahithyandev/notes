...
lastUpdatedOn: 2026-04-28T07:56:31.644Z
---
...
[object-oriented paradigm](/s2/program-construction/object-oriented-paradigm/).
...
- synchronization locks: Mechanisms to manage thread-safe access to the object. More on this [here](/s2/program-construction/concurrency/).
...
- `List`, `Queue`, `Set` interfaces extends `Collection` to specific data
  structures
- [ArrayList](/s2/program-construction/arraylist/) is a dynamic array
  implementation
