...
lastUpdatedOn: 2026-09-13T14:55:22.872Z
---
...
- Flyweight Factory  
  Ensures that flyweight objects are shared and reused. Maintains a pool of
  flyweight objects and returns existing objects from the pool instead of
  creating new ones.
- Flyweight Object  
  Contains the intrinsic state and methods to operate on it.
