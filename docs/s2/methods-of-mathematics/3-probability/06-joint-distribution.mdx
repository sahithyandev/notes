...
lastUpdatedOn: 2026-09-13T14:55:22.794Z
---
...
- Positive covariance means higher than mean values of one variable tend to be
  paired with higher than mean values of the other variable.
- Negative covariance means higher than mean values of one variable tend to be
  paired with lower than mean values of the other variable.
...
- Discrete case  
  $\forall x,y\;\;P(X = x, Y = y) \geq 0$
- Continuous case  
  $\forall x,y\;\;f_{X,Y}(x, y) \geq 0$
...
- Discrete variables  
  Probability mass tables or matrices.
- Continuous variables  
  Joint density functions or contour plots.
- Copulas  
  Functions that describe the dependence structure between variables.
