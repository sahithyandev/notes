...
lastUpdatedOn: 2026-09-13T04:43:42.352Z
---
...
- Chopping  
  Chop off the digits $d_{k+1}d_{k+2} \dots$ to produce the floating-point form.
- Rounding  
  When $d_{k+1} ≥ 5$, add $1$ to $d_k$ to obtain $fl(y)$ and then chop off all but the first k digits.
