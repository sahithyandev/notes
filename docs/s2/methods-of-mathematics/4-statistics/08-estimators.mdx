...
lastUpdatedOn: 2026-09-08T19:46:17.682Z
---
...
If a statistic $e$ is used as an estimator for population parameter $\theta$ and $E(e) = \theta$, then it is said to be an unbiased estimator of $\theta$.
