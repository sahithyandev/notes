...
lastUpdatedOn: 2026-09-13T04:43:42.265Z
---
...
- Sketch an empty with (1 vs 1 or 1 vs 2, or 2 vs 2 ...)
  - If the variables in a row or column is more than 2, they must be arranged in
    [gray code](/s2/computer-organization-and-digital-design/basics/number-systems/#gray-codes).
...
- The product can be written as:
  - Product of sums  
    $M3 \cdot M4 \cdot M6 \cdot M7$
  - Using production notation  
    $\prod{M(3,4,6,7)}$
