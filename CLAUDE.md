...
Progress (queued, each agent tool-use step, proposed/error, apply/discard/refine, style-check follow-ups, the child process's own stderr) is logged to the terminal running `bun dev`, not just to the browser.
